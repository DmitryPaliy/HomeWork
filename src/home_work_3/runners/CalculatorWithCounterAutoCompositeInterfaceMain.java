...
public class CalculatorWithCounterAutoCompositeInterfaceMain {
    ...
    public static void main(String[] args) {
        CalculatorWithCounterAutoAgregationInterface agregationInterface = new CalculatorWithCounterAutoAgregationInterface(new CalculatorWithMathCopy());
        double numMultiplication = agregationInterface.multiplication(15, 7);
        double numDivision = agregationInterface.division(28, 5);
        double numExponentation = agregationInterface.exponentation(numDivision, 2);
        double sum1 = agregationInterface.summation(4.1, numMultiplication);
        double sum2 = agregationInterface.summation(numExponentation, sum1);
